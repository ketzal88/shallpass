...
import { FormSectionCiudadania } from "../components/FormSection/FormSectionCiudadania";
    ...
    <>
      <Row className={`justify-content-md-center ${styles.bgR}`}>
        ...
        <Col className={`${styles.main}`}>
          ...
          />
          <HighLigthText
            text={`Beneficios <br/>de obtener la <br/>ciudadanía <br/>española`}
          />
      ...
      <Row className={`justify-content-md-center ${styles.bgL}`}>
        <Row
          className={`justify-content-md-center ${styles.explainerContainer}`}
        >
        ...
        <Col className={`${styles.main}`}>
          <HeroText
            titel={`Servicio de armado de<br/>carpeta`}
            copy={`Con nuestro servicio vas a obtener`}
          />
          <CardGrid2 cardData={servicios} />
          <Price id={idPage} />
          <FormSectionCiudadania
            id={idPage}
            submitText={"Hablemos por WhatsApp"}
          />
