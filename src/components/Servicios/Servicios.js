          ...
          <Row md={colums} className={`${styles.serviciosRow} g-3`}>
            {cont.map((data, id) => (
              <Col key={id} className={isMobile && "mb-5"}>
                <Col
                  className={`${data.dark ? styles.dark : styles.light} ${
                ...
                >
                  {data.highlight !== "" ? (
                    <Col
                      className={`${
                        darkHighlight ? styles.darkHighlight : styles.highlight
                      }`}
                    >
                  ...
                  <Col>
                    ...
                    />
                    <small className={`${styles.priceClaim}`}>
                      {data.priceClaim}
                    </small>
                    ...
                    <p
                      ...
                      dangerouslySetInnerHTML={{ __html: sanitizer(data.note) }}
                    />
                    <Container>
                      <Row>
                        <Button
